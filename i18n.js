...
Object.assign(translations.fr, {
  catalogs_name_placeholder: 'Films 2026',
  catalogs_name_required: 'Nom requis',
  catalogs_sort_save: 'Enregistrer le tri',
  catalogs_save_error: 'Impossible d’enregistrer le tri',
  catalogs_updates_active: 'Mises à jour actives',
  catalogs_pause_updates: 'Geler les mises à jour',
  catalogs_resume_updates: 'Reprendre les mises à jour',
  catalogs_frozen: 'Contenu gelé',
  catalogs_visible: 'Visible dans Stremio',
  catalogs_hidden: 'Masqué du manifeste Stremio',
  catalogs_guide_prefix: 'guide',
  catalogs_guide_label: 'Guide de sélection et d’ordre',
  catalogs_guide_none: 'Aucun guide — filtres locaux uniquement',
  catalogs_guide_help: 'Le catalogue sera l’intersection entre ce guide et les médias déjà indexés.'
});
Object.assign(translations.en, {
  catalogs_name_placeholder: 'Films 2026',
  catalogs_name_required: 'Name required',
  catalogs_sort_save: 'Save sorting',
  catalogs_save_error: 'Could not save sorting',
  catalogs_updates_active: 'Updates active',
  catalogs_pause_updates: 'Pause updates',
  catalogs_resume_updates: 'Resume updates',
  catalogs_frozen: 'Content frozen',
  catalogs_visible: 'Visible in Stremio',
  catalogs_hidden: 'Hidden from Stremio manifest',
  catalogs_guide_prefix: 'guide',
  catalogs_guide_label: 'Selection and ordering guide',
  catalogs_guide_none: 'No guide — local filters only',
  catalogs_guide_help: 'The catalog will contain the intersection of this guide and already indexed media.'
});
Object.assign(translations.de, {
  catalogs_name_placeholder: 'Filme 2026',
  catalogs_name_required: 'Name erforderlich',
  catalogs_sort_save: 'Sortierung speichern',
  catalogs_save_error: 'Sortierung konnte nicht gespeichert werden',
  catalogs_updates_active: 'Aktualisierungen aktiv',
  catalogs_pause_updates: 'Aktualisierungen pausieren',
  catalogs_resume_updates: 'Aktualisierungen fortsetzen',
  catalogs_frozen: 'Inhalt eingefroren',
  catalogs_visible: 'In Stremio sichtbar',
  catalogs_hidden: 'Im Stremio-Manifest verborgen',
  catalogs_guide_prefix: 'Leitliste',
  catalogs_guide_label: 'Leitliste für Auswahl und Reihenfolge',
  catalogs_guide_none: 'Keine Leitliste – nur lokale Filter',
  catalogs_guide_help: 'Der Katalog enthält die Schnittmenge aus Leitliste und bereits indizierten Medien.'
});

// Current language (default: DE)
let currentLang = 'de';
